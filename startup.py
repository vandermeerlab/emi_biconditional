...
def load_events(matfile):
    ...
    events['trial1_stop'] = loading_events['evt_trial1_stop'][0]
    events['trial2_start'] = loading_events['evt_trial2_start'][0]
    events['trial2_stop'] = loading_events['evt_trial2_stop'][0]
    events['trial3_start'] = loading_events['evt_trial3_start'][0]
    events['trial3_stop'] = loading_events['evt_trial3_stop'][0]
    events['trial4_start'] = loading_events['evt_trial4_start'][0]
    events['trial4_stop'] = loading_events['evt_trial4_stop'][0]
